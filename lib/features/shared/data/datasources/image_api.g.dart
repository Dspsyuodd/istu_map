...
class _ImageApi implements ImageApi {
  ...
  @override
  Future<GetImagesResult> getImages(String objectId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<GetImagesResult>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GetImagesResult.fromJson(_result.data!);
    return value;
  }
